...
<body class="bg-slate-950 text-slate-100 min-h-screen antialiased selection:bg-indigo-500 selection:text-white">
    ...
    <section class="pt-32 pb-20 px-6 text-center max-w-4xl mx-auto">
        ...
        <h1 class="text-4xl md:text-6xl font-extrabold mt-6 tracking-tight">
            Gawin Nating Katotohanan Ang Iyong <span class="bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent">Pangarap na Website</span>
        </h1>
        <p class="mt-4 text-slate-400 text-lg max-w-2xl mx-auto">
            Mabilis, modern, at responsive na mga web applications na babagay sa iyong negosyo o personal branding.
        </p>
    </section>

    <section id="rates" class="py-12 px-6 max-w-6xl mx-auto">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold">Mga Rate at Package</h2>
            <p class="text-slate-400 mt-2">Pumili ng package na angkop sa pangangailangan ng iyong proyekto.</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between hover:border-slate-700 transition">
                <div>
                    ...
                    <p class="text-sm text-slate-400 mt-1">Para sa personal branding o simpleng produkto.</p>
                    <div class="my-6">
            ...
            <div class="bg-gradient-to-b from-indigo-950/40 to-slate-900 border-2 border-indigo-500 rounded-2xl p-6 flex flex-col justify-between relative shadow-xl shadow-indigo-950/50">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-400 mt-1">Saktong-sakto sa maliliit at katamtamang negosyo.</p>
                    <div class="my-6">
            ...
            <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between hover:border-slate-700 transition">
                <div>
                    ...
                    <p class="text-sm text-slate-400 mt-1">Komplikadong web app, e-commerce, o database system.</p>
                    <div class="my-6">
                        <span class="text-3xl font-extrabold text-white">₱35,000+</span>
                        <span class="text-slate-400 text-sm"> / depende sa sakop</span>
                    </div>
                    <ul class="space-y-3 text-sm text-slate-300">
    ...
    <section id="form-section" class="py-12 px-6 max-w-2xl mx-auto">
        <div class="bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-lg">
            <h3 class="text-2xl font-bold mb-2 text-white">Magpadala ng Quote Request</h3>
            <p class="text-slate-400 text-sm mb-6">Punan ang form para makipag-ugnayan tungkol sa ipapagawa mong website.</p>

            <form id="quoteForm" onsubmit="submitForm(event)" class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1">Pangalan</label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-1">Piniling Package</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-1">Halaga / Rate</label>
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1">Detalye ng Proyekto</label>
                    <textarea id="details" rows="4" placeholder="Ilarawan nang maikli ang gusto mong ipagawa..." class="w-full bg-slate-950 border border-slate-800 rounded-lg px-4 py-2.5 text-white focus:outline-none focus:border-indigo-500"></textarea>
                </div>
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 rounded-lg transition-all">Ipadala ang Request</button>
            </form>
